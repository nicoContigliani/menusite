...
// import { useMenuData, type MenuItem, type DataGeneral, useMenuDataAternative } from '../../../hooks/useMenuData';
...
//     { name: "ProfileGeneric", path: "ProfileGeneric/ProfileGeneric" },
// ]
...
//     const { component: SelectedProfileComponent } = dynamicProfiles.find(profile => profile.name === selectedProfile) || { component: null };
...
//             return <div className={styles.error}>Perfil no encontrado</div>;
//         }
//         return (
    ...
    const renderContent = () => {
        ...
        return (
            <SelectedProfileComponent
                ...
                schedules={schedules}
                config={config || []}
                // css={styles||null} // Pass the CSS to the component
                menuItems={dataGeneral} // Pass the original data
            />
        )
    }
