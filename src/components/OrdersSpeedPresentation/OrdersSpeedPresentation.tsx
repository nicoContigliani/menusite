...
//   const [ordersByStatus, setOrdersByStatus] = useState<any[] | any | undefined>([]);
...
//     const orders = uniqueOrders.sort((a, b) =>
//       new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()
//     );

//     const groupedOrders = orders.reduce((acc, order) => {
//       const status = order.status.toLowerCase(); // Normalizar a minúsculas por si acaso
//       if (!acc[status]) {
//         acc[status] = []; // Inicializar el array si no existe
//       }
//       acc[status].push(order); // Agregar el pedido al estado correspondiente
//       return acc;
//     }, {});
