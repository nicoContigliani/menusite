...
// import { Button, Typography, Box, Paper, Alert, AppBar, Toolbar, Avatar } from '@mui/material';
...
//     if (!nombre) {
//         return {
//             notFound: true, // Devuelve 404 si no hay nombre
//         };
//     }
...
//         { title: "employees", url: `${baseUrl}/employees/${nombre}` },
//         { title: "company", url: `${baseUrl}/company/${nombre}` },
//         { title: "dashboard", url: `${baseUrl}/company/dashboard/${nombre}` }
//     ])
...
//                             Scan this QR Code by {item?.title}
//                         </Typography>
